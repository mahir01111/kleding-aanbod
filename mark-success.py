...
history = {"updated_at": datetime.now(timezone.utc).isoformat(), "products": {row["url"]: {"price": row["price"], "name": row["name"], "evidence_version": row.get("evidence_version", 1)} for row in products}}
